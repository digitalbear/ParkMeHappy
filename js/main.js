...
var latitude = 52.623411;
var longitude = 1.295254;
...
function showDefaultMap() {
	//latitude = 52.623411;
	//longitude = 1.295254;
	latitude = 52.63149689873963;
	longitude = 1.274688242306143;
	window.location = "#map-page";
}
...
/*$("#xSearch").submit(function(event) {
	...
	$.get(url, function(data) {
		...
		$.each(data, function(i, item) {
			$("#result")
			.append("<li>Post Codelat:" + data.lat)
		})
		$("#result")
		.append("lat:" + data.lat)
		.append("long:" + data.long);
...
$( document ).on( "pageshow", "#map-page", function() {
	...
	*/
	//var myLocation = new google.maps.LatLng(52.623798, 1.294910);
    ...
    /*var heatmapData = [
	  {location: new google.maps.LatLng(52.623798, 1.294910), weight: 2},
	  {location: new google.maps.LatLng(52.623828, 1.294889), weight: 1},
	  {location: new google.maps.LatLng(52.623241, 1.295736), weight: 4},
	  {location: new google.maps.LatLng(52.623678, 1.294320), weight: 3},
	  {location: new google.maps.LatLng(52.624362, 1.295060), weight: 10},
	  {location: new google.maps.LatLng(52.623502, 1.296487), weight: 5}
    ];*/
